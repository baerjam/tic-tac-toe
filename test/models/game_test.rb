...
class GameTest < ActiveSupport::TestCase
  ...
  test 'game ends in a draw' do
    @game.board.record_move(0, 0, 'X')
    @game.board.record_move(0, 1, 'O')
    @game.board.record_move(0, 2, 'X')
    @game.board.record_move(1, 0, 'O')
    @game.board.record_move(1, 1, 'O')
    @game.board.record_move(1, 2, 'X')
    @game.board.record_move(2, 0, 'X')
    @game.board.record_move(2, 1, 'X')
    @game.board.record_move(2, 2, 'O')
